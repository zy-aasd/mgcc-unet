...
class setting_config:
    ...
    if datasets == 'ISIC2017':
        data_path = '../../data/isic2017/ISIC-2017_Training_Data/2000/'
    ...
    criterion = BceDiceLoss(wb=0.5, wd=1.0)
    ...
    if opt == 'Adadelta':
        lr = 0.01  # default: 1.0 – coefficient that scale delta before it is appliedattn to the parameters
    ...
    if sch == 'StepLR':
        ...
        eps = 1e-08  # – Minimal decay appliedattn to lr. If the difference between new and old lr is smaller than eps, the update is ignored. Default: 1e-8.
