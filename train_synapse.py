...
parser.add_argument('--output_dir', type=str, default='../model/mgcc-synapse', help='output dir')
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        net = seg_net(in_ch=3, start_ch=48, num_classes=args.num_classes, img_size=args.img_size,
                      granular_sizes=[args.img_size,args.img_size//2,args.img_size//4], up_factor=[1,2,4], loops=[1,2,3,4]).cuda()
        net.load_state_dict(torch.load('./pretrained/MGCC-pretrained.pth'), strict=False)
